;(function(factory) {
    ...
    editormd.prototype    = editormd.fn = {
        ...
        init : function (id, options) {
            ...
            {
                markdownTextarea.attr("name", (settings.name !== "") ? settings.name : id + "markdown");
            }
            
            var appendElements = [
                (!settings.readOnly) ? "<a href=\"javascript:;\" class=\"fa fa-close " + classPrefix + "preview-close-btn\"></a>" : "",
                ( (settings.saveHTMLToTextarea) ? "<textarea class=\"" + classNames.textarea.html + "\" name=\"" + id + "html\"></textarea>" : "" ),
